...
<body class="no-js">
	...
	<div id="info" class="popover clearfix">
		...
		<div id="info-panel" style="display: block;">
			...
			<!--
			This collection of names would not have been as complete without these wonderful people:</p>
			<p class="clearfix">
				<?php
		...
		<div id="api-panel">
			...
			<h2>Basic Usage</h2>
<pre>https://names.nnaemekanweke.com/api/
<span>---</span>
{
  ...
  <span class="key">"region"</span>: <span class="val">"United States"</span>
			...
			<pre><span>https://names.nnaemekanweke.com/api/</span>?amount=25</pre>
			<p>Limit results to the <code>male</code> or <code>female</code> gender:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?gender=female</pre>
			<p>Region-specific results:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?region=germany</pre>
			<p>Require a minimum number of characters in a name:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?minlen=25</pre>
			<p>Require a maximum number of characters in a name:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?maxlen=75</pre>
			<p>For JSONP, specify a callback function to wrap results in:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?callback=example</pre>
			<!-- no region currently supports different languages
			<p>Results for a language within a region:</p>
			<pre><span>https://names.nnaemekanweke.com/api/</span>?region=switzerland&amp;language=german</pre>
			-->
			<h2>Extra Data</h2>
...
<pre><span>https://names.nnaemekanweke.com/api/</span>?ext
<span>---</span>
{
  <span class="key">"name"</span>: <span class="val">"John"</span>,
  <span class="key">"surname"</span>: <span class="val">"Doe"</span>,
  ...
  <span class="key">"photo"</span>: <span class="val">"https://names.nnaemekanweke.com/api/photos/male/1.jpg"</span>
}
</pre>
